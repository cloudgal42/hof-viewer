...
import {RangeSetting} from "../components/randomcity/AlgoSettings/RangeSetting.tsx";
import {DropdownSetting} from "../components/settings/SettingSection/DropdownSetting.tsx";

const Settings = () => {
  return (
    <div className="mx-4 mx-sm-5 flex-grow-1 d-flex flex-column flex-lg-row justify-content-center">
      <SectionNav />
      <div className="main-wrapper flex-grow-1">
        ...
        <section id="translation">
          <h3 className="fs-4 mb-3">City/Creator Name Translation</h3>
          <DropdownSetting
          ...
          >
            ...
            <option value="none">Show translated/transilaterated name only</option>
          </DropdownSetting>
          <DropdownSetting
            label="City Name"
